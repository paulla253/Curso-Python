...
#Faça um algoritmo que solicite ao usuário digitar o seu nome e em seguida envie a seguinte frase
# para a saída padrão: "O seu nome é: [nome do usuário]".

# nome = input("Digite seu nome: ")
# print("Seu nome é ", nome)

#Faça um algoritmo que solicite o nome e a idade do usuário e então,
...
#Faça um algoritmo que solicite ao usuário informar 3 números. Em seguida,
...
#Faça um algoritmo que solicite ao usuário informar 2 números. Em seguida, some os valores
...
#09-Faça um algoritmo em que o usuário informe uma medida em metros.
...
# Faça um algoritmo que solicite a largura e a altura de um quadrado.
...
# Faça um algoritmo que solicite ao usuário informar o valor de uma compra. Em seguida, aplique 10% de desconto e
